...
import 'package:honchos_driver_app/view/forgetPassword/forget_password_screen.dart';
...
class _LoginScreenState extends State<LoginScreen> {
  ...
  getUserName() async {
    ...
    FirebaseFirestore.instance.collection('Driver').where('phone', isEqualTo:prefs.getString('userPhone')).get().then((value) {
      setState(() {
