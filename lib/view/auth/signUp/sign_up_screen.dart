...
import 'package:honchos_driver_app/model/get_cart_model.dart';
import 'package:honchos_driver_app/model/input_validator.dart';
import 'package:honchos_driver_app/model/session_model.dart';
import 'package:honchos_driver_app/model/user_model.dart';
...
class _SignUpScreenState extends State<SignUpScreen> {
  ...
  void signUp() async {
    ...
    try{
      var request = http.MultipartRequest('POST', Uri.parse('https://restaurant.wettlanoneinc.com/api/register_driver'));
      ...
      if (response.statusCode == 200) {
        ...
        FirebaseFirestore.instance.collection('Driver').doc().set({
          ...
          var snackBar = SnackBar(content: Text('Driver registered successfully'
  ...
  void signIn() async {
    ...
    var request = http.MultipartRequest('POST', Uri.parse('http://restaurant.wettlanoneinc.com/api/login_driver'));
