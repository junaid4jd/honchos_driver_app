...
import 'package:honchos_driver_app/view/verifyPhone/verify_otp_phone_screen.dart';
...
class _ForgetPasswordScreenState extends State<ForgetPasswordScreen> {
  ...
  Future forgetPassword() async {
    ...
    // };
    var request = http.Request('POST', Uri.parse('http://restaurant.wettlanoneinc.com/api/driver_forgot_password?email=${_controller.text.toString()}'));
  ...
  void getToken() async {
    ...
    var request1 = http.Request('GET', Uri.parse('http://restaurant.wettlanoneinc.com/api/driver_get_otp_email'));
