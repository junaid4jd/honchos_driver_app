...
import 'package:honchos_driver_app/view/chooseRestaurant/choose_restaurant_screen.dart';
                                  ...
                                  onPressed: () async {
                                    ...
                                    if(_phoneController.text.isEmpty) {
                                      ...
                                      if(_phoneController.text.length < 7) {
                                        ...
                                        final snapshot = await FirebaseFirestore.instance.collection('Driver').get();
