...
//import 'package:honchos_driver_app/dashBoard/dashboard_screen.dart';
import 'package:honchos_driver_app/model/cartModel.dart';
import 'package:honchos_driver_app/model/get_cart_model.dart';
import 'package:honchos_driver_app/model/product_model.dart';
import 'package:honchos_driver_app/model/restaurant_model.dart';
import 'package:flutter/material.dart';
import 'package:geolocator/geolocator.dart';
import 'package:get/get.dart';
import 'package:honchos_driver_app/view/auth/signUp/sign_up_screen.dart';
...
class _ChosseRestaurantScreenState extends State<ChosseRestaurantScreen> {
  ...
  getRestaurants() async {
    ...
    var request = http.Request(
        'GET', Uri.parse('http://restaurant.wettlanoneinc.com/api/restaurants_driver'));
